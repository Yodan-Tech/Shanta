...
> file is the highest-priority change you can make — drift from AGENTS.md is drift from
...
- [AGENTS.md](AGENTS.md) — this file: project memory, read first every session.
...
- [.Codex/commands/README.md](.Codex/commands/README.md) — 5 Shanta slash commands.
...
- **Update this file** whenever an architectural decision changes. AGENTS.md is authoritative.
